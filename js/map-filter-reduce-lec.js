...
//Filter Method
//Creates new array with all the elements that pass the test implemented
...
//array.reduce(function(preVal, currentVal) {}, startingPoint)

let grades = [92,88,76,88,70,100]

let total = grades.reduce((preValue, currentValue)=> preValue + currentValue, 100)
...
let combinedSentence = sentenceArray.reduce((previousValue,
currentValue) => previousValue + currentValue, 'Hey Juan!');
